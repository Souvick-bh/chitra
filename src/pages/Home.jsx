  ...
  return (
    <div className='flex flex-col lg:flex-row justify-between font-bold font-serif  '>
      ...
      <div className='w-screen text-amber-50 pt-20 pb-20 text-center border-b-2 lg:border-0 border-[#ffffff] '>
        ...
        <div className='flex gap-12 pl-6 pt-6 lg:pr-6 lg: lg:border-l-2 border-[#ffffff] lg:items-center '>
                <div className='relative duration-150 ease-in-out m-4 hover:m-1 hover:w-80 hover bg-[#6C757D] rounded-2xl shadow-2xl w-70 text-center group'>
