...
function Footer() {
  return (
    <div className='border-t-2 border-[#ffffff] flex flex-col  '>
        ...
        <div className='flex flex-col mt-6 ml-25 justify-items-start'>
        ...
        <div className='flex m-12 justify-around bg-[#6c757d] opacity-30 p-3 rounded-4xl text-3xl w-xs'>
            ...
            <a href='https://x.com/SouvickBho17054'>
              <FaSquareXTwitter  className='cursor-pointer text-amber-50 hover:text-[#000000]' />
            </a>
            <a href='https://github.com/Souvick-bh'>
              <FaGithub className='cursor-pointer text-amber-50 hover:text-[#000000]'/>
            </a>
            {/* <a href="">
              <FaDiscord className='cursor-pointer text-amber-50 hover:text-[#000000]'/>
            </a> */}
